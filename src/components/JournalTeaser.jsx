    ...
    <section id="journal" className="relative bg-bone py-28 md:py-40">
      <div className="px-6 md:px-10 max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-16 md:mb-20">
          <Reveal>
            <p className="text-[11px] uppercase tracking-widest2 text-maroon/60 mb-4">The Journal — 06</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          <Reveal className="lg:col-span-7">
            <a href="#/journal" className="block group">
              ...
              <div className="mt-6">
                ...
                <p className="mt-4 text-[11px] uppercase tracking-widest2 text-maroon/70">
                  By {featured.author}
                </p>
              </div>
            </a>
          ...
          <div className="lg:col-span-5 flex flex-col divide-y divide-maroon/15 border-y border-maroon/15">
            {grid.map((p, i) => (
              <Reveal key={p.id} delay={i * 80}>
                <a href="#/journal" className="block py-7 group">
                  ...
                  <p className="mt-3 text-[11px] uppercase tracking-widest2 text-charcoal/50">
